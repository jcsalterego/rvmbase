...
module Config
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/rvm/rubies/ruby-1.8.6-p420")
  CONFIG["ruby_install_name"] = "ruby"
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "ruby"
  CONFIG["MANTYPE"] = "doc"
  CONFIG["NROFF"] = "/usr/bin/nroff"
  CONFIG["configure_args"] = " '--prefix=/usr/local/rvm/rubies/ruby-1.8.6-p420' '--enable-shared' '--disable-install-doc'"
  CONFIG["sitedir"] = "$(DESTDIR)/usr/local/rvm/rubies/ruby-1.8.6-p420/lib/ruby/site_ruby"
  ...
  CONFIG["exec_prefix"] = "$(DESTDIR)/usr/local/rvm/rubies/ruby-1.8.6-p420"
  CONFIG["PACKAGE_URL"] = ""
