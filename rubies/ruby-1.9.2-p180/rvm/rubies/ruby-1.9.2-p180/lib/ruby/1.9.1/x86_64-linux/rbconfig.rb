...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/rvm/rubies/ruby-1.9.2-p180")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/rvm/rubies/ruby-1.9.2-p180' '--enable-shared' '--disable-install-doc' '--with-libyaml-dir=/usr/local/rvm/usr'"
